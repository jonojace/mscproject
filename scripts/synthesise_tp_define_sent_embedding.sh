...
# ********************************************************************************
# This differs from synthesise_tp.sh
# as you can generate with any sent_embedding you want, defined in sent_embedding_file
#
# see use_arbitrary_sent_embedding_testtime.py for more information about how it works
# ********************************************************************************
...
python ${SCRIPT_DIR}/use_arbitrary_sent_embedding_testtime.py ${PROMPT_LAB_FOLDER}
